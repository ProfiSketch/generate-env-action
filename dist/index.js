...
const typings_1 = __nccwpck_require__(3837);
...
const fs_1 = __importDefault(__nccwpck_require__(5747));
const pocketbase_1 = __importDefault(__nccwpck_require__(8714));
    ...
    for (const key in plainFiles) {
        if (Object.hasOwnProperty.call(plainFiles, key)) {
            ...
            if (envVar) {
                ...
                (0, core_1.warning)(`🚧 MISSING VARIABLE - '${key}', file generation skipped (${path})`);
            }
        }
    }
}
