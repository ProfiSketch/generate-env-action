...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        (0, core_1.debug)(`generate-env-action started (${process.env.npm_package_version})`);
        try {
...
const PlainFile = zod_1.z.object({
